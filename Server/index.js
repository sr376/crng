...
// // mongoose
// //     .connect(`mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@<your-cluster-name>.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`)
// //     .then(() => {
// //         app.listen(process.env.PORT, () => {
// //             console.log("Server running...");
// //         });
...
// mongoose
//     .connect(`mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@<clust>.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`)
//     .then(() => {
//         app.listen(process.env.PORT, () => {
...
// MongoDB connection for local MongoDB instance
mongoose.set('strictQuery', true);
